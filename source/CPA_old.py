...
for bnum in range(0, 16):
    ...
    index=bestguess[bnum] = np.argmax(maxcpa)
    plt.plot(maxcpa)
    plt.plot(index,maxcpa[index],'ks')
    show_max='['+str(index)+','+str(maxcpa[index])+']'
    plt.annotate(show_max,xytext=(index,maxcpa[index]),xy=(index,maxcpa[index]))
    plt.show()
    print (maxcpa[kguess])
